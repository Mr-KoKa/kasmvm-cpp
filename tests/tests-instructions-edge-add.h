#ifndef TESTS_INSTRUCTIONS_EDGE_ADD_H
#define TESTS_INSTRUCTIONS_EDGE_ADD_H

#include "tests-constants.h"
#include "tests-instructions-edge--init.h"

std::vector<InstructionEdgeTest> add_tests = {
    InstructionEdgeTest(
        "add MIN, MIN",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MIN,  -9",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, -9, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MIN,  -8",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, -8, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MIN,  -1",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, -1, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MIN,   0",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, 0, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MIN, MAX",
        std::vector<int32_t>({7, 1, 0, std::numeric_limits<int>::min(), 48, 0, 2147483647, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9, MIN",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
            return std::string("2147483639|ZF: FALSE, SF: FALSE, OF: TRUE"); //2147483639,ZF: FALSE, SF: FALSE, OF: TRUE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9,  -9",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, -9, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9,  -8",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, -8, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9,  -1",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, -1, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9,   0",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, 0, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -9, MAX",
        std::vector<int32_t>({7, 1, 0, -9, 48, 0, 2147483647, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8, MIN",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
            return std::string("2147483640|ZF: FALSE, SF: FALSE, OF: TRUE"); //2147483640,ZF: FALSE, SF: FALSE, OF: TRUE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8,  -9",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, -9, 0}),
        []() -> std::string {
            return std::string("-17|ZF: FALSE, SF: TRUE, OF: FALSE"); //-17,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8,  -8",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, -8, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8,  -1",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, -1, 0}),
        []() -> std::string {
            return std::string("-9|ZF: FALSE, SF: TRUE, OF: FALSE"); //-9,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8,   0",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, 0, 0}),
        []() -> std::string {
            return std::string("-8|ZF: FALSE, SF: TRUE, OF: FALSE"); //-8,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -8, MAX",
        std::vector<int32_t>({7, 1, 0, -8, 48, 0, 2147483647, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1, MIN",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
            return std::string("2147483647|ZF: FALSE, SF: FALSE, OF: TRUE"); //2147483647,ZF: FALSE, SF: FALSE, OF: TRUE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1,  -9",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, -9, 0}),
        []() -> std::string {
            return std::string("-10|ZF: FALSE, SF: TRUE, OF: FALSE"); //-10,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1,  -8",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, -8, 0}),
        []() -> std::string {
            return std::string("-9|ZF: FALSE, SF: TRUE, OF: FALSE"); //-9,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1,  -1",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, -1, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1,   0",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, 0, 0}),
        []() -> std::string {
            return std::string("-1|ZF: FALSE, SF: TRUE, OF: FALSE"); //-1,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add  -1, MAX",
        std::vector<int32_t>({7, 1, 0, -1, 48, 0, 2147483647, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add   0, MIN",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
            return std::string("-2147483648|ZF: FALSE, SF: TRUE, OF: FALSE"); //-2147483648,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add   0,  -9",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, -9, 0}),
        []() -> std::string {
            return std::string("-9|ZF: FALSE, SF: TRUE, OF: FALSE"); //-9,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add   0,  -8",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, -8, 0}),
        []() -> std::string {
            return std::string("-8|ZF: FALSE, SF: TRUE, OF: FALSE"); //-8,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add   0,  -1",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, -1, 0}),
        []() -> std::string {
            return std::string("-1|ZF: FALSE, SF: TRUE, OF: FALSE"); //-1,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add   0,   0",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, 0, 0}),
        []() -> std::string {
            return std::string("0|ZF: TRUE, SF: FALSE, OF: FALSE"); //0,ZF: TRUE, SF: FALSE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add   0, MAX",
        std::vector<int32_t>({7, 1, 0, 0, 48, 0, 2147483647, 0}),
        []() -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX, MIN",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, std::numeric_limits<int>::min(), 0}),
        []() -> std::string {
            return std::string("-1|ZF: FALSE, SF: TRUE, OF: FALSE"); //-1,ZF: FALSE, SF: TRUE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX,  -9",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, -9, 0}),
        []() -> std::string {
            return std::string("2147483638|ZF: FALSE, SF: FALSE, OF: FALSE"); //2147483638,ZF: FALSE, SF: FALSE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX,  -8",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, -8, 0}),
        []() -> std::string {
            return std::string("2147483639|ZF: FALSE, SF: FALSE, OF: FALSE"); //2147483639,ZF: FALSE, SF: FALSE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX,  -1",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, -1, 0}),
        []() -> std::string {
            return std::string("2147483646|ZF: FALSE, SF: FALSE, OF: FALSE"); //2147483646,ZF: FALSE, SF: FALSE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX,   0",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, 0, 0}),
        []() -> std::string {
            return std::string("2147483647|ZF: FALSE, SF: FALSE, OF: FALSE"); //2147483647,ZF: FALSE, SF: FALSE, OF: FALSE
        },
        [](VM &vm, std::string _stdout) -> std::string {
    ...
    InstructionEdgeTest(
        "add MAX, MAX",
        std::vector<int32_t>({7, 1, 0, 2147483647, 48, 0, 2147483647, 0}),
        []() -> std::string {
